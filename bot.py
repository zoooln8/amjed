#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Telegram Number Scanner Bot - Railway Edition
...
if not BOT_TOKEN:
    ...
    print("🔧 في Railway: إذهب إلى Variables وأضف BOT_TOKEN")
    exit(1)

DEVELOPER = "@laging24"
DEVELOPER_NAME = "Amjad Mohammed"

# إعداد Flask للـ Health Check (مطلوب لـ Railway)
app = Flask(__name__)
...
def home():
    ...
    <body style="text-align: center; padding: 50px; font-family: Arial;">
        ...
        <p>المطور: {Amjad_mohammed}</p>
        <p>اليوزر: {@laging24}</p>
        <p>الحالة: ✅ البوت يعمل على Railway</p>
...
@app.route('/health')
def health():
    return {"status": "healthy", "service": "telegram-bot", "developer": DEVELOPER_NAME}, 200
...
👨‍💻 <b>المطور:</b> {Amjad_mohammed} ({Amjad})
☁️ <b>الاستضافة:</b> Railway (24/7 مجاني)
...
{Amjad}
    ...
    async def developer_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        keyboard = [[InlineKeyboardButton("📞 تواصل مع المطور", url=f"https://t.me/{Amjad[1:]}")]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        
        dev_text = f"""
👨‍💻 <b>معلومات المطور</b>

<b>الاسم:</b> {Amjad_mohammed}
<b>اليوزر:</b> {@laging24}
